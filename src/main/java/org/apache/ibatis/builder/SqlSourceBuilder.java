...
public class SqlSourceBuilder extends BaseBuilder {
     ...
     *
     * @param originalSql 原始 SQL，经过SqlNode.apply （）方法处理之后的SQL语句
     * @param parameterType 参数类型，用户传入的实参类型
     * @param additionalParameters 附加参数集合。可能是空集合，也可能是 {@link org.apache.ibatis.scripting.xmltags.DynamicContext#bindings} 集合
     *                             记录了形参与实参的对应关系，其实就是经过SqlNode.apply （）方法处理后的DynamicContext.bindings集合
     * @return SqlSource 对象
     */
    ...
    private static class ParameterMappingTokenHandler extends BaseBuilder implements TokenHandler {
        ...
        //下面是buildParameterMapping（）方法的实现，负责解析参数属性：
        private ParameterMapping buildParameterMapping(String content) {
            ...
            // 创建 ParameterMapping.Builder 对象,并设置ParameterMapping相关配置
            ...
            // 注意，如果没有指定TypeHandler,就会在这里的build（）方法中，
