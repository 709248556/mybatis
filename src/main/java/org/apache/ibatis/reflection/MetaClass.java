...
public class MetaClass {
    ...
    private final ReflectorFactory reflectorFactory;//用于缓存Reflector对象
    ...
    public boolean hasGetter(String name) {
        ...
        if (prop.hasNext()) {
            ...
            if (reflector.hasGetter(prop.getName())) {
                // 创建 MetaClass 对象
                //这里的rnetaClassForProperty(PropertyTokenizer）方法是上面介绍的rnetaClassForProperty(String）方法的重载，但两者逻辑相差有点大
                MetaClass metaProp = metaClassForProperty(prop);
