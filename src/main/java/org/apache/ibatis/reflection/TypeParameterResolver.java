...
public class TypeParameterResolver {
     ...
     * 解析类型
     *
     * 该方法会根据其第一个参数的类型，即字段、方法返回值或方法参数的类型，选择合适的方法进行解析。
     * 第二个参数表示查找该字段、返回值或方法参数的起始位置。
     * 第三个参数则表示该字段、方法定义所在的类
     *
     * @param type 类型
     * @param srcType 来源类型
    ...
    private static Type resolveType(Type type, Type srcType, Class<?> declaringClass) {
        ...
        } else if (type instanceof ParameterizedType) {//是否是泛型
