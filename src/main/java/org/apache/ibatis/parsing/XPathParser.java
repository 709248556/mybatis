...
public class XPathParser {
    ...
    //提供了一系列的 eval *（）方法用 于解析 boolean short long int String Node
    //等类型的信息，它通过调用XPath.evaluate（）方法查找指定路径的节点或属性，并进
    //行相应的类型装换。
    ...
    private Document createDocument(InputSource inputSource) {
        ...
        try {
            ...
            //对 DocumentBuilderFactory 对象进行一系列配置
