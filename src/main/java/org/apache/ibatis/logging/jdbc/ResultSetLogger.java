...
public final class ResultSetLogger extends BaseJdbcLogger implements InvocationHandler {
    ...
    private static Set<Integer> BLOB_TYPES = new HashSet<>();//记录了超大长度的类型
    private boolean first = true;//是否是ResultSet结采集的第一行
    private int rows;//统计行数
    private final ResultSet rs;//真正的ResultSet对象
    private final Set<Integer> blobColumns = new HashSet<>();//记录了起大字段的列编号
